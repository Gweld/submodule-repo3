The description of Ant, Maven, and Gradle integration is available at https://docs.parasoft.com/display/JTEST20211/Integrating+with+Build+Systems
...
1. Configure your Maven setup by following the Jtest User Guide:
   https://docs.parasoft.com/display/JTEST20211/Configuring+the+Jtest+Plugin+for+Maven
...
3. Run the following command to execute the tests affected by your change:
   mvnw clean tia:affected-tests test -Dparasoft.coverage.file=tia/coverage.xml -Dparasoft.test.file=tia/report.xml
   or
   gradlew clean affectedTests test -Dparasoft.coverage.file=tia/coverage.xml -Dparasoft.test.file=tia/report.xml
...
For more information see:
   https://docs.parasoft.com/display/JTEST20211/Testing+and+Analysis+with+Maven
   https://docs.parasoft.com/display/JTEST20211/Testing+and+Analysis+with+Gradle
...
For more information see https://docs.parasoft.com/display/JTEST20211/Application+Coverage
